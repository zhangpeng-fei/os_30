...
void init_screen8(char *vram, int x, int y)
{
	...
	putfonts8_asc(vram, x, 11, y - 22 , COL8_FF0000, "菜单");
	return;
}
...
void init_menu(struct SHEET *sht){
	...
	boxfill8(vram, xsize, COL8_C6C6C6, 0, 0, xsize - 1, ysize - 1);	//背景色处纴E
	...
	putfonts8_asc(vram, xsize, 8, 7 + yskip * 2, COL8_000000,	"程序   >");
...
//struct SHEET *init_infomation(struct SHTCTL *shtctl){   //初始化  个人信息  图层
...
//	sht_info->flags |= 0x40;				//0x40 表示该图层  为   菜单  选项之一
//	make_window8(sht_info->buf, sht_info->bxsize, sht_info->bysize, "个人信息", 0);
//	make_textbox8(sht_info, 8, 28, sht_info->bxsize - 16, sht_info->bysize - 36, COL8_FFFFFF);
//	putfonts8_asc(sht_info->buf, sht_info->bxsize, 8, 28, COL8_000000,	"班级:  计科1301");
//	putfonts8_asc(sht_info->buf, sht_info->bxsize, 8, 28 + 16, COL8_000000,	"姓名:  彭明藩 ");
//	putfonts8_asc(sht_info->buf, sht_info->bxsize, 8, 28 + 32, COL8_000000,	"学号:  201308010116");
//	return sht_info;
//}
