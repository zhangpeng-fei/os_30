...
void HariMain(void)
{
	...
	win = api_openwin(buf, 400, 120, -1, "CrystalCPUID for PandaOS");
	...
	api_boxfilwin(win, 6, 24, 400-6, 120-6, 15);
	api_boxfilwin(win, 7, 25, 400-7, 120-7, 7);
